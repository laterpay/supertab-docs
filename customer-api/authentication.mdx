...
Additionally, all calls to the Customer API must also include the `X-Supertab-Client-Id` header with your client id. See [Clients](#clients) for more information.
