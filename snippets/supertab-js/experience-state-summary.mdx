<ResponseField name="priorEntitlement" type="PriorEntitlement | null">
  Data about prior entitlement of the current user. `null` if user has no prior entitlement.

  <Expandable title="Prior entitlement object">
...
<ResponseField name="purchase" type="Purchase | null">
  ...
  <Expandable title="Purchase object">
    ...
    <ResponseField name="entitlementStatus" type="object">
...
<ResponseField name="purchasedOffering" type="Offering | null">
  ...
  <Expandable title="Offering object">
    ...
    <ResponseField name="entitlementDetails" type="object">
...
<ResponseField name="tab" type="Tab">
  ...
  This object contains information about the tab total, the limit of a tab, its currency, and previous purchases.
