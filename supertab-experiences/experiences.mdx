...
**Prerequisite:** you need to create your Websites and Offerings before setting up a Paywall.

We automatically create the first Paywall for each new Website using default time passes.
...
<Steps>
  ...
  <Step title="Button setup">
    From the Website dropdown, choose the Website on which you will use the Button. Select **Purchase Button** as the Experience type.
  </Step>
