...
**Prerequisite:** you need to create your <a href="./sites">sites</a> and <a href="./products-offerings-pricing">offerings</a> before setting up a Paygate.
...
<Steps>
  ...
  <Step title="Install the code snippet">
    ...
    The experience will automatically launch when the page loads. Supertab manages customer <a href="./access-management">access</a> for you.
