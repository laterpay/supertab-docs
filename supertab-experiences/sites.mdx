...
<Steps>
  ...
  <Step title="(Optional) Add a logo">
    You can add a logo for each of your Sites. We will automatically use it in some Experiences (e.g. Paywall) and in the purchase flow to better align with your brand.
