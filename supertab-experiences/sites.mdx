...
<Steps>
  ...
  <Step title="Create your first site">
    ...
    It's important to get the URL correct as Supertab uses this to make sure customers are logged in securely when interacting with your site.
  ...
  <Step title="(Optional) Add a logo">
    You can add a logo for each of your Sites. We will automatically use it in some Experiences (e.g. Basic Paygate) and in the purchase flow to better align with your brand.
