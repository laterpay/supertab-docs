...
Identity verification (KYC) and providing financial information for payouts can be deferred until you’re ready to go live. You can create Sites, Offerings, and Experiences without completing this step; however, it must be finalized before enabling Live Mode and accepting payments.
...
* Each <a href="/supertab-experiences/sites">Site</a> generates a Test Client and a Live Client. The Experience Editor automatically uses the correct ID based on the selected mode.
