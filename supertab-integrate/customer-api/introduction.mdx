...
your customer's browser. It is used to purchase pre-defined [offerings](/supertab-experiences/products-offerings-pricing)
or [arbitrary micro purchases](/dead), and powers Supertab Experiences.

## Customer SDK

It is best to utilise the Customer API through the Supertab [Customer SDK](/dead).
The underlying API is documented here as reference for what is happening "under the hood".
All examples include their Customer SDK equivalents.
