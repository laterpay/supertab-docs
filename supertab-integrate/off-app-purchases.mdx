...
When a user clicks the link, they’re taken to the Supertab Off-App Purchase Page, where they sign in and confirm their purchase. Once completed, Supertab redirects them back to your app with purchase details included in the URL’s query parameters.
...
After a user completes or exits the purchase flow, they’re redirected to your app with the following query parameters:
