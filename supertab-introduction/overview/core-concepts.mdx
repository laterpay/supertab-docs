...
New customers receive Tabs with a limit of $1, rising to $5 (or local equivalent) after the first payment.
...
* The customer has not made any purchases for 30 days.
