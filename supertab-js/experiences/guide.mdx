...
Supertab.js makes it simple to embed powerful monetization flows into your Website.
...
Replace `client.your_client` with the live or test client ID associated with Website you created
