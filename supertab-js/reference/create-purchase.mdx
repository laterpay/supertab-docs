...
| `uiConfig`         | [`CreatePurchaseUiConfig`](#uiconfig) | No       | Custom color configuration for the purchase widget.                 |
...
<div style={{ flex: "1", minWidth: "300px" }}>
  ...
  <div style={{ flex: "1", minWidth: "300px" }}>
    ...
    >
      Widget with custom colors: red text (#FF0000) and blue background
      (#0000FF)
    </p>
  </div>
</div>
