...
1) Go to https://business.supertab.co [link missing]
2) Create an account by direct email setup or social login. 
3) Verify your email address by clicking on Verigy My Email and following the instructions.
...
1) Click on the "Finish setting up your account" button WHERE???? 
