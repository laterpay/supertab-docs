---
title: 'Test Mode'
description: 'Test your integration without processing real transactions.'
---
...
- The Installation tab in the Experience Editor allows the toggling between modes and provides ready-to-use code snippets, eliminating the need for manual ID swapping. 
...
## Using Stripe Test Credit Cards
