...
| Feature            | Benefit                                                       |
|--------------------|---------------------------------------------------------------|
| Off-App Purchases  | Bypass app store purchases and retain revenue                  |
| Custom Metadata    | Track purchases with precision and context in one smooth flow  |
| Redirect Flow      | Effortless journey—from click to confirmation and back to app  |
